...
public class TransfertNationalApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		admin1.setFullName("Hamza habibou");
		admin1.setAdminName("admin1");
		admin1.setPassword("passwordAdmin1");
		adminRepository.save(admin1);

		Admin admin2 = new Admin();
		admin2.setFullName("Abdelhafid Khribech");
		...
		clientEntity5.setClientId(utils.generateStringId(30));
		clientEntity5.setTitre("M");
		...
		clientEntity6.setClientId(utils.generateStringId(30));
		clientEntity6.setTitre("M");
		...
		clientEntity7.setClientId(utils.generateStringId(30));
		clientEntity7.setTitre("M");
		...
		Compte compteEntity5 = new Compte();
		compteEntity5.setCompteId(utils.generateStringId(30));
		compteEntity5.setNumCompte(utils.generateNumbre(16));
		compteEntity5.setSolde(50000);
		compteEntity5.setClient(clientEntity5);
		compteRepository.save(compteEntity5);

		Compte compteEntity6 = new Compte();
		compteEntity6.setCompteId(utils.generateStringId(30));
		compteEntity6.setNumCompte(utils.generateNumbre(16));
		compteEntity6.setSolde(60000);
		compteEntity6.setClient(clientEntity6);
		compteRepository.save(compteEntity6);

		Compte compteEntity7 = new Compte();
		compteEntity7.setCompteId(utils.generateStringId(30));
		compteEntity7.setNumCompte(utils.generateNumbre(16));
		compteEntity7.setSolde(70000);
		compteEntity7.setClient(clientEntity7);
		compteRepository.save(compteEntity7);
